  ...
  return (
    <section className='w-screen min-w-screen flex flex-col justify-center items-center gap-8'>
        <aside className="w-full flex flex-col justify-center gap-4 items-center">
            ...
            <h2 className='text-7xl text-white font-bold'>Convierte audios y vídeos en texto con <strong className='text-blue-600/80'>precisión</strong></h2>
            <p className='text-lg text-gray-500 font-medium w-1/4 max-w-1/4'>Sube tu archivo y obtén resultados en cuestión de minutos. Soporte de múltiples idiomas, traducción automática.</p>
            <button 
