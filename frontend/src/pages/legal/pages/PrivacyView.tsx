        ...
        <main className='min-h-screen bg-[#0a0e17] text-white'>
            ...
            <div className='max-w-3xl mx-auto px-6 py-16'>
                ...
                >
                    ...
                    <div className='p-4 bg-blue-600/10 border border-blue-500/20 rounded-xl'>
                        <p className='text-sm text-slate-300 leading-relaxed'>
                            ...
                            en <a href='mailto:privacidad@audwave.app' className='text-blue-400 hover:text-blue-300 transition-colors'>privacidad@audwave.app</a>.
                        </p>
                    </div>
                </motion.div>
                ...
                >
                    ...
                    <a
                        href='mailto:privacidad@audwave.app'
